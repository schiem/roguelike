...
namespace tiledef {
    Tile OVERWORLD_DIRT = {44, 1, BROWN, true, false, false, false};
    Tile DIRT = {44, 1, BROWN, true, false, false, false};
    ...
    Tile TREE = {84, 6, GREEN, false, false, true, false};
    ...
    Tile KOBOLD = {107, 10, RED, false, false, false, false};
}
